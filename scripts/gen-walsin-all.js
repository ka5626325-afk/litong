...
const productsData = {
  ...
  seoKeywords: ["华新被动元件", "Walsin MLCC", "芯片电阻", "射频元件", "电感", "Walsin distributor"],
  faqs: [
    {
  ...
  categories: [
    {
      ...
      selectionGuideLink: { url: "/walsin/support/mlcc-selection-guide.html", text: "MLCC选型指南" },
      series: [
      ...
      selectionGuide: { title: "MLCC选型指南", description: "如何选择合适的华新MLCC电容", articleId: "mlcc-selection", articleLink: "/walsin/support/mlcc-selection-guide.html" },
      faqs: [
      ...
      products: [
        {
          ...
          companionParts: [
            { partNumber: "RC0603JR-0710KL", relationship: "配套使用", description: "10kΩ电阻，与MLCC配合组成RC滤波" }
          ]
        },
        {
          partNumber: "0805X475M6R3NT",
          name: "0805 X5R 4.7uF 6.3V MLCC",
          description: "0805尺寸X5R