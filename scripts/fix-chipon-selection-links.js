#!/usr/bin/env node
/**
 * Fix selectionGuideLink format for ChipON brand data
 * Convert string links to object format with url and text
 */
  ...
  data.categories.forEach(cat => {
    ...
    if (typeof cat.selectionGuideLink === 'string') {
      ...
      cat.selectionGuideLink = {
        url: url,
        text: `View ${cat.selectionGuide} for detailed selection guidance`
      };
    } else if (!cat.selectionGuideLink || typeof cat.selectionGuideLink !== 'object') {
      cat.selectionGuideLink = {
        url: `/chipon/support/${cat.slug}-selection-guide.html`,
        text: `View ${cat.selectionGuide} for detailed selection guidance`
      };
    }
...
// Main execution
console.log('🔧 Fixing ChipON selectionGuideLink format and remaining issues...\n');
